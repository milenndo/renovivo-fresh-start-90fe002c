...
const projectsBG: Project[] = [
  // ========== ИНОВАТИВНИ ПОКРИТИЯ ==========
  {
    ...
    duration: "2 седмици",
    area: "45 кв.м.",
    description: "Terrazzo под в просторна дневна с естествени камъни в топли тонове. Издръжливост над 75 години и лесна поддръжка.",
    ...
    stages: [
      ...
      { title: "Подготовка", description: "Изравняване на основата до равна повърхност." },
  ...
  },
  {
    ...
    duration: "10 дни",
    area: "85 кв.м.",
    description: "Цялостно микроциментово покритие на под и стени в модерен апартамент. Безшевна повърхност в антрацитен цвят, която създава усещане за повече пространство.",
  ...
  },
  {
    ...
    duration: "2 дни",
    area: "12 кв.м.",
    description: "Каменен килим на балкон с ефективен дренаж и приятен вид. Решение на проблема с локви и замръзване през зимата.",
    ...
    features: ["Директно върху стари плочки", "Ефективен дренаж", "Морозоустойчивост", "Естествени камъчета", "Минимална поддръжка"],
    stages: [
  ...
  // ========== ЦЯЛОСТЕН РЕМОНТ ==========
  {
    ...
    result: {
      summary: "Обновихме остарял апартамент до модерно, светло и функционално жилище. Клиентът получи 40% повече полезна площ с отворената планировка.",
      metrics: [
  ...
  },
  {
    ...
    duration: "3 седмици",
    area: "12 кв.м.",
    description: "Баня с мраморни плочки, дъждовна душ система и free-standing вана. Проектът включва подово отопление и LED осветление.",
    challenge: "Малко пространство, което трябваше да се използва максимално, без да изглежда претрупано.",
  ...
  },
  {
    ...
    duration: "3 седмици",
    area: "60 кв.м.",
    description: "Довършителни работи на просторна дневна от 60 кв.м. в ново строителство. Пространството е оформено с мека мебел в неутрални тонове, акцентна стена с дървена текстура и минималистично обзавеждане.",
  ...
  },
  {
    ...
    duration: "2 седмици",
    area: "9 кв.м.",
    description: "Модерна баня с микроциментово покритие без фуги. Безшевна повърхност с минималистичен дизайн и лесна поддръжка.",
