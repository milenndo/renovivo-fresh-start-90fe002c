...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for Renovivo — a renovation services company in Bulgaria. Read service categories and blog posts, and submit or (for admins) list site-inspection requests. All tools act as the signed-in Renovivo user and respect row-level security.",
