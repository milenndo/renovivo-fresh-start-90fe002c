...
const mockConversation = [
  ...
  {
    role: "assistant",
    content: "Разбрах. За 6 кв.м. баня с едроформатни плочки и средна класа санитария, ориентировъчният бюджет е между 4,350 - 6,140 €. Това включва: къртене, хидроизолация, ВиК, плочки с монтаж, санитария и довършителни работи. Искате ли детайлна разбивка?",
  },
];
