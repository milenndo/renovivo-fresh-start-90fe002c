...
export default function Testimonials() {
  ...
  // ВАЖНО: Review/AggregateRating schema е премахната умишлено.
  // Structured data за отзиви се добавя само когато отзивите са реални и
  // проверими (Google Business Profile). Маркиране на илюстративни отзиви
  // е нарушение на Google Rich Results политиките и води до ръчна санкция.
