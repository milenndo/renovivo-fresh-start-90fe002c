    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Цената за цялостен ремонт на апартамент в София започва от около 250-350 лв/м² за основен ремонт и достига 500-800 лв/м² за луксозен ремонт с висок клас материали. Renovivo прави безплатен оглед и изготвя точна оферта според вашия проект.",
        },
      },
      {
        "@type": "Question",
