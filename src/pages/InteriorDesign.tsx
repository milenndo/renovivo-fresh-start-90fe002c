  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Професионален интериорен дизайн в София - цялостна концепция, 3D визуализация, избор на материали и цветове. Ясен план, реалистична визуализация и коректно изпълнение." 
        />
