...
const translations: Record<Language, Record<string, string>> = {
  bg: {
    ...
    'service.kitchen.title': 'Кухни и мебели по поръчка',
    'service.kitchen.desc': 'Изработка на кухни и корпусна мебел по индивидуален проект и размери.',
    ...
    // About
    'about.label': 'За нас',
    'about.title': 'Ремонти, направени както трябва',
    'about.p1': 'Renovivo е екип от специалисти за ремонт на жилища в София и региона. Работим по ясен план, с фиксирана цена и график, и поемаме целия процес — от огледа до предаването на готовия обект.',
    'about.p2': 'Приемаме ограничен брой проекти едновременно, за да можем да следим лично всяка фаза. Целта е проста: качествено изпълнение, спазени срокове и спокойствие за клиента.',
    'about.feature1': 'Един отговорен ръководител на обекта',
    'about.feature2': 'Проверени материали и доставчици',
    'about.feature3': 'Един контакт за всички въпроси',
    'about.feature4': 'Фиксирана цена по договор',
    'about.feature5': 'Спазени срокове',
    'about.feature6': 'Ежедневни снимки от обекта',
    'about.projects': 'завършени проекта',
    'about.recommend': 'се връщат за нов проект',
    'about.warranty': 'години гаранция',
    'about.warrantyAll': 'На труд и материали',
    'about.cta': 'Научете повече за нас',

    // Why Us
    'whyUs.label': 'Защо Renovivo',
    'whyUs.title': 'Ясен процес, ясна цена, качествено изпълнение',
    'whyUs.subtitle': 'Работим за клиенти, които искат ремонт без изненади — с един отговорен човек, ясен договор и спазени срокове.',
    'whyUs.experts.title': 'Един екип от начало до край',
    'whyUs.experts.desc': 'Ръководител на обекта и постоянен екип майстори — без подизпълнители и непознати лица на обекта.',
    'whyUs.detail.title': 'Внимание към детайла',
    'whyUs.detail.desc': 'Проверяваме всяка фуга, всеки ръб и всеки монтаж. Финалният преглед е подробен и с вас.',
    'whyUs.communication.title': 'Един номер, един човек',
    'whyUs.communication.desc': 'Без кол центрове. Ежедневна връзка със снимки и решения през личен канал.',
    'whyUs.budget.title': 'Прозрачна цена',
    'whyUs.budget.desc': 'Оферта с ясни позиции и количества. Без скрити разходи. Всяка промяна се съгласува писмено.',
    'whyUs.location': 'София и региона',

    // How We Work
    'howWeWork.title': 'Как работим',
    'howWeWork.subtitle': 'Четири стъпки от първия контакт до предаването на готовия обект.',
    'howWeWork.step1.title': 'Оглед на място',
    'howWeWork.step1.desc': 'Идваме на обекта, слушаме какво искате, измерваме и снимаме. Обсъждаме възможностите и сроковете.',
    'howWeWork.step2.title': 'Оферта и договор',
    'howWeWork.step2.desc': 'Изготвяме детайлна оферта с материали, количества и фиксирана цена. Подписваме договор и започваме работа.',
    'howWeWork.step3.title': 'Изпълнение',
    'howWeWork.step3.desc': 'Обектът е чист и защитен. Получавате снимки от напредъка всеки ден. Ние поемаме координацията на всички екипи.',
    'howWeWork.step4.title': 'Предаване на обекта',
    'howWeWork.step4.desc': 'Финално почистване и предаване на готовия обект с всички документи: гаранции, инструкции и контакти на доставчиците.',

    // CTA
    'cta.title': 'Заявете безплатен оглед',
    'cta.subtitle': 'Оставете вашите данни и ще се свържем с вас в рамките на 24 часа, за да уговорим оглед на място.',
    'cta.inspection': 'Заявете оглед',
    ...
    'services.item.furniture': 'Мебели по поръчка — кухни и корпусна мебел',
    'services.item.furniture.desc': 'Кухни, гардероби, дрешници и шкафове по индивидуален проект',
    ...
    'pricing.page.vatNote': '* Цените са без ДДС.',
    ...
    'aboutPage.metaDesc': 'Renovivo е ремонтна фирма в София, създадена с една цел - да ви спестим притесненията. 127 завършени проекта, 94% препоръки, 2 години гаранция.',
    ...
    'aboutPage.values.item5': 'Гаранция 2 години',
  ...
  en: {
    ...
    'service.kitchen.title': 'Custom Kitchens & Cabinetry',
    'service.kitchen.desc': 'Kitchens and cabinetry made to your project and measurements.',
    ...
    'about.title': 'Renovations done properly',
    'about.p1': 'Renovivo is a team of specialists for home renovation in Sofia and the region. We work to a clear plan, with a fixed price and schedule, and handle the whole process — from the site visit to handing over the finished home.',
    'about.p2': 'We take on a limited number of projects at a time so we can personally oversee every stage. The goal is simple: quality work, deadlines kept, and peace of mind for the client.',
    'about.feature1': 'One accountable site manager',
    'about.feature2': 'Trusted materials and suppliers',
    'about.feature3': 'One point of contact for everything',
    'about.feature4': 'Fixed price in the contract',
    'about.feature5': 'Deadlines kept',
    'about.feature6': 'Daily photos from the site',
    'about.projects': 'completed projects',
    'about.recommend': 'come back for another project',
    'about.warranty': 'years warranty',
    'about.warrantyAll': 'On labour and materials',
    'about.cta': 'Learn more about us',

    // Why Us
    'whyUs.label': 'Why Renovivo',
    'whyUs.title': 'Clear process, clear price, quality work',
    'whyUs.subtitle': 'For clients who want a renovation without surprises — with one responsible person, a clear contract and deadlines kept.',
    'whyUs.experts.title': 'One team from start to finish',
    'whyUs.experts.desc': 'A site manager and a permanent crew of tradespeople — no subcontractors and no unfamiliar faces on site.',
    'whyUs.detail.title': 'Attention to detail',
    'whyUs.detail.desc': 'We check every joint, every edge and every fitting. The final walk-through is thorough and done with you.',
    'whyUs.communication.title': 'One number, one person',
    'whyUs.communication.desc': 'No call centres. Daily updates with photos and decisions through a direct channel.',
    'whyUs.budget.title': 'Transparent price',
    'whyUs.budget.desc': 'A quote with clear items and quantities. No hidden costs. Any change is agreed in writing.',
    'whyUs.location': 'Sofia and the region',

    // How We Work
    'howWeWork.title': 'How we work',
    'howWeWork.subtitle': 'Four steps from the first contact to handing over the finished project.',
    'howWeWork.step1.title': 'Site visit',
    'howWeWork.step1.desc': 'We come to the site, listen to what you want, measure and take photos. We discuss options and timelines.',
    'howWeWork.step2.title': 'Quote and contract',
    'howWeWork.step2.desc': 'We prepare a detailed quote with materials, quantities and a fixed price. We sign a contract and start work.',
    'howWeWork.step3.title': 'Execution',
    'howWeWork.step3.desc': 'The site is kept clean and protected. You receive daily progress photos. We coordinate all trades.',
    'howWeWork.step4.title': 'Handover',
    'howWeWork.step4.desc': 'Final cleaning and handover of the finished project with all documents: warranties, care instructions and supplier contacts.',

    // CTA
    'cta.title': 'Book a free site visit',
    'cta.subtitle': 'Leave your details and we will get back to you within 24 hours to arrange a visit.',
    'cta.inspection': 'Book a site visit',
    'cta.inquiry': 'Send an enquiry',
    ...
    'services.item.furniture': 'Custom Furniture — Kitchens & Cabinetry',
    ...
    'pricing.page.vatNote': '* Prices are without VAT.',
    ...
    'aboutPage.metaDesc': 'Renovivo is a renovation company in Sofia, created with one goal - to save you from worries. 127 completed projects, 94% recommendations, 2-year warranty.',
    ...
    'aboutPage.values.item5': '2-year warranty',
    ...
    'pricing.guarantee': '2-year warranty',
    ...
    'faq.a4': 'We provide a 2-year written warranty on all workmanship, plus the manufacturer warranty on the installed materials. Our warranty covers any defects in materials and installation.',
