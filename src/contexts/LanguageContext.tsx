...
const translations: Record<Language, Record<string, string>> = {
  bg: {
    ...
    // About
    'about.label': 'Ателие Renovivo',
    'about.title': 'Тихият куратор на вашия дом',
    'about.p1': 'Renovivo не е строителна фирма — ние сме ателие за жилищна архитектура и завършек. Всеки квадратен метър се третира като лична колекция: подбрани материали, авторска светлина, безшумно изпълнение зад затворени врати.',
    'about.p2': 'Работим с ограничен брой обекти годишно, за да можем да присъстваме лично на всяка фаза. Резултатът е дом, който не крещи, а разказва — на вас и на гостите ви — една тиха, безупречна история.',
    'about.feature1': 'Дискретен project lead',
    'about.feature2': 'Материали от авторски селекции',
    'about.feature3': 'Един контакт, нула хаос',
    'about.feature4': 'Фиксиран бюджет, черно на бяло',
    'about.feature5': 'Съблюдаван график до час',
    'about.feature6': 'Ежедневен фото-репорт',
    'about.projects': 'реализирани интериора',
    'about.recommend': 'се връщат за втори обект',
    'about.warranty': 'години гаранция',
    'about.warrantyAll': 'На труд и материали',
    'about.cta': 'Запознайте се с ателието',

    // Why Us
    'whyUs.label': 'Защо Renovivo',
    'whyUs.title': 'Стандарт, който не се обяснява — усеща се',
    'whyUs.subtitle': 'Работим за клиенти, които ценят тишината, прецизността и присъствието на един отговорен човек. Не за масовия пазар — за вашия дом.',
    'whyUs.experts.title': 'Ателиен подход',
    'whyUs.experts.desc': 'Един lead architect и малък екип майстори, посветени изцяло на вашия проект — без подизпълнителска верига.',
    'whyUs.detail.title': 'Обсебени от детайла',
    'whyUs.detail.desc': 'Фуга по фуга, ръб по ръб. Финалният преглед е с фенерче и рулетка — не на око.',
    'whyUs.communication.title': 'Един номер, един човек',
    'whyUs.communication.desc': 'Никакви call-центрове. Ежедневен brief, снимки и решения през личен канал — както с личния ви лекар.',
    'whyUs.budget.title': 'Прозрачен бюджет',
    'whyUs.budget.desc': 'Оферта с фиксирани позиции, без „изненади" по средата. Всяка промяна се подписва предварително.',
    'whyUs.location': 'София · Бояна · Драгалевци · Витоша',

    // How We Work
    'howWeWork.title': 'Ритуалът на един проект',
    'howWeWork.subtitle': 'Четири фази, изградени за клиенти, които нямат време за грешки — само за резултати.',
    'howWeWork.step1.title': 'Discovery оглед',
    'howWeWork.step1.desc': 'Идваме при вас — слушаме, снимаме, измерваме. Излизаме с ясна визия и график, не с празни обещания.',
    'howWeWork.step2.title': 'Проектна оферта',
    'howWeWork.step2.desc': 'Получавате детайлно портфолио с материали, визуализации и фиксирана цена. Подписваме — и започваме.',
    'howWeWork.step3.title': 'Тихо изпълнение',
    'howWeWork.step3.desc': 'Обектът е чист, защитен и охраняван. Ежедневен фото-репорт. Вие продължавате живота си — ние поемаме останалото.',
    'howWeWork.step4.title': 'Предаване „под ключ"',
    'howWeWork.step4.desc': 'Финално почистване, styling и връчване на ключовете с досие: гаранции, инструкции, контакти на всеки доставчик.',

    // CTA
    'cta.title': 'Резервирайте своя discovery оглед',
    'cta.subtitle': 'Приемаме ограничен брой нови проекти всяко тримесечие. Оставете детайли — свързваме се лично в рамките на 24 часа.',
    'cta.inspection': 'Заяви discovery оглед',
    'cta.inquiry': 'Изпратете brief',
  ...
  en: {
    ...
    // About
    'about.label': 'Renovivo Atelier',
    'about.title': 'The quiet curator of your home',
    'about.p1': 'Renovivo is not a construction company — we are an atelier for residential architecture and finish. Every square metre is treated as a private collection: hand-picked materials, sculpted light, silent execution behind closed doors.',
    'about.p2': 'We take on a limited number of projects each year so we can be personally present at every phase. The result is a home that does not shout — it tells, quietly and impeccably, your story.',
    'about.feature1': 'Discreet project lead',
    'about.feature2': 'Curated material library',
    'about.feature3': 'One contact, zero chaos',
    'about.feature4': 'Fixed budget, in writing',
    'about.feature5': 'Timeline honoured to the hour',
    'about.feature6': 'Daily photo report',
    'about.projects': 'residences delivered',
    'about.recommend': 'return for a second project',
    'about.warranty': 'years warranty',
    'about.warrantyAll': 'On labour and materials',
    'about.cta': 'Meet the atelier',

    // Why Us
    'whyUs.label': 'Why Renovivo',
    'whyUs.title': 'A standard you feel — not one we explain',
    'whyUs.subtitle': 'For clients who value silence, precision and one accountable person. Not for the mass market — for your home.',
    'whyUs.experts.title': 'Atelier approach',
    'whyUs.experts.desc': 'One lead architect and a small dedicated crew — no subcontractor chain, no unfamiliar faces.',
    'whyUs.detail.title': 'Obsessed with the detail',
    'whyUs.detail.desc': 'Grout by grout, edge by edge. The final walk-through happens with a flashlight and a ruler.',
    'whyUs.communication.title': 'One number, one person',
    'whyUs.communication.desc': 'No call centres. A daily brief, photos and decisions through a private channel — as with your family doctor.',
    'whyUs.budget.title': 'Transparent budget',
    'whyUs.budget.desc': 'Fixed line-item pricing. No mid-project "surprises". Every change is signed off in advance.',
    'whyUs.location': 'Sofia · Boyana · Dragalevtsi · Vitosha',

    // How We Work
    'howWeWork.title': 'The ritual of a project',
    'howWeWork.subtitle': 'Four phases, built for clients who have no time for mistakes — only for results.',
    'howWeWork.step1.title': 'Discovery visit',
    'howWeWork.step1.desc': 'We come to you — we listen, photograph, measure. You leave with a clear vision and timeline, not empty promises.',
    'howWeWork.step2.title': 'Design proposal',
    'howWeWork.step2.desc': 'You receive a detailed portfolio with materials, renders and a fixed price. We sign — and we begin.',
    'howWeWork.step3.title': 'Silent execution',
    'howWeWork.step3.desc': 'The site is clean, protected and secure. A daily photo report. You carry on with life — we handle the rest.',
    'howWeWork.step4.title': 'Turn-key handover',
    'howWeWork.step4.desc': 'Final cleaning, styling and a handover dossier: warranties, care manuals and every supplier contact.',

    // CTA
    'cta.title': 'Reserve your discovery visit',
    'cta.subtitle': 'We accept a limited number of new projects each quarter. Leave your details — we respond personally within 24 hours.',
    'cta.inspection': 'Book discovery visit',
    'cta.inquiry': 'Send a brief',
